...
public class GaleriaAdaptor extends RecyclerView.Adapter<GaleriaAdaptor.PerfilViewHolder>{

    ArrayList<PMascotas> mascotas;
    //Activity activity;

    public GaleriaAdaptor(ArrayList<PMascotas> mascotas){
    ...
    @Override
    public void onBindViewHolder(@NonNull GaleriaAdaptor.PerfilViewHolder holder, int position) {
