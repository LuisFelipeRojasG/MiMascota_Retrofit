...
import com.stingrey.mismascotas.presentador.FavoritasViewFragmentPresenter;
import com.stingrey.mismascotas.presentador.IFavoritasViewFragmentPresenter;

import java.util.ArrayList;

public class FavoritasViewFragment extends Fragment implements IFavoritasViewFragment {

    private ArrayList<PMascotas> mascota;
    private RecyclerView listaMascotas;
    private IFavoritasViewFragmentPresenter presenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        presenter = new FavoritasViewFragmentPresenter(this, getContext());
